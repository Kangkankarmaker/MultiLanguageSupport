package com.kangkan.developer.multilanguagesupport;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button=findViewById(R.id.btn_seciond);
        ...
        //        Fetching sharedpreferences to get Locale stored inthem
    ...
    private void setupImageBasedOnLocale(String localeString) {
        ...
        if(localeString.equals(HINDI_LOCALE)){
            ivWelcome.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_menu_camera));
        } else {
            ivWelcome.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_menu_gallery));
